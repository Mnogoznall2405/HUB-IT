...
| 35 | **No human review trigger** | Agent decides everything | "Preserve applicable approval requirements and approvals already granted; ask only for actions outside the authorized scope" |
