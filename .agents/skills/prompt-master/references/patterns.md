...
| # | Pattern | Bad Example | Fixed |
|---|---------|------------|-------|
| 26 | **Missing decision criteria** | "which approach is better?" | Specify constraints and ask for the recommendation, concise trade-offs and supporting evidence |
...
| 35 | **No human review trigger** | Agent decides everything autonomously | "Preserve applicable approval requirements and approvals already granted; ask only for actions outside the authorized scope" |
