...
description: Create a repository-grounded threat model when explicitly requested.
---
...
- Previously confirmed service context satisfies this checkpoint; do not ask for the same confirmation again. If essential context still needs confirmation, pause the final report and wait for user feedback, while preparing independent sections. Do not treat silence as confirmation.
