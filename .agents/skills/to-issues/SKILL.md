---
name: to-issues
description: Break an agreed plan or PRD into implementation issues when requested.
---
...
Iterate until the user approves the breakdown. A breakdown already approved in the conversation satisfies this requirement; ask again only when the proposed breakdown materially changes.
