...
from backend.api.deps import get_current_active_user, get_current_user, require_permission
...
async def cleanup_sessions(
    ...
    return session_service.cleanup_sessions(force=True)
...
async def purge_inactive_sessions(
    ...
    return session_service.purge_inactive_sessions()
