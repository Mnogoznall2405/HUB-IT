...
def _run_postgres_app_schema_maintenance(connection) -> None:
    statements = [
        ...
        'ALTER TABLE IF EXISTS "app"."sessions" ADD COLUMN IF NOT EXISTS "auth_method" VARCHAR(32) NOT NULL DEFAULT \'legacy\'',
        'ALTER TABLE IF EXISTS "app"."sessions" ADD COLUMN IF NOT EXISTS "trusted_device_id" VARCHAR(64) NULL',
        'ALTER TABLE IF EXISTS "app"."sessions" ADD COLUMN IF NOT EXISTS "client_browser_family" VARCHAR(32) NOT NULL DEFAULT \'unknown\'',
        'ALTER TABLE IF EXISTS "app"."sessions" ADD COLUMN IF NOT EXISTS "client_os_family" VARCHAR(32) NOT NULL DEFAULT \'unknown\'',
        'ALTER TABLE IF EXISTS "app"."sessions" ADD COLUMN IF NOT EXISTS "client_fingerprint_hash" VARCHAR(64) NOT NULL DEFAULT \'\'',
        'CREATE INDEX IF NOT EXISTS "ix_app_sessions_trusted_device_id" ON "app"."sessions" ("trusted_device_id")',
