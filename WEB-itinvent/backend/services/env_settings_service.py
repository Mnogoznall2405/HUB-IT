...
_DIRECT_DESCRIPTIONS = {
    ...
    "DOCFLOW_FILE_AD_USER": ("1С Документооборот", "Выделенная сервисная AD-учётная запись для чтения файловых томов 1С."),
    "DOCFLOW_FILE_AD_PASSWORD": ("1С Документооборот", "Пароль выделенной сервисной AD-учётной записи файловых томов 1С."),
    "DOCFLOW_FILE_AD_DOMAIN": ("1С Документооборот", "Домен выделенной сервисной AD-учётной записи файловых томов 1С."),
    ...
    "DOCFLOW_1C_ASSIGNMENT_PROCESS_TYPE": ("1С Документооборот", "Проверенный тип бизнес-процесса поручения."),
    "DOCFLOW_GATEWAY_URL": ("1С Документооборот", "Loopback URL выделенного шлюза COM-сессий 1С."),
    "DOCFLOW_GATEWAY_TOKEN": ("1С Документооборот", "Внутренний токен backend → docflow gateway."),
