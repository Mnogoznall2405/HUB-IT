...
_DIRECT_DESCRIPTIONS = {
    ...
    "TASK_EMAIL_FROM_EMAIL": ("Почта и SMTP", "Адрес отправителя email-уведомлений по задачам."),
    "TASK_EMAIL_FROM_NAME": ("Почта и SMTP", "Отображаемое имя отправителя email-уведомлений по задачам."),
    ...
    "TASK_EMAIL_TRANSPORT": ("Почта и SMTP", "Канал отправки уведомлений по задачам: exchange или smtp."),
    "TASK_EMAIL_EWS_LOGIN": ("Почта и SMTP", "Логин Exchange (NTLM) для ящика уведомлений по задачам."),
    "TASK_EMAIL_EWS_PASSWORD": ("Почта и SMTP", "Пароль Exchange для ящика уведомлений по задачам."),
