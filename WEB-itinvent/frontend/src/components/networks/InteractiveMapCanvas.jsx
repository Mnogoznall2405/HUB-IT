    ...
    <Box sx={{ position: 'relative' }}>
      ...
      <Stack
        ...
        sx={{
          ...
          top: 8,
          zIndex: 3,
          bgcolor: ui.isDark ? 'rgba(23,26,31,0.82)' : 'rgba(255,255,255,0.88)',
          border: '1px solid',
      ...
      >
        <Tooltip title="Увеличить">
          <IconButton size="small" sx={{ color: ui.iconPrimary }} onClick={() => zoomBy(0.1)}>
                        ...
                        {label && !mobile && (
                          <Typography
                            ...
                            sx={{
                              ...
                              fontWeight: 700,
                              bgcolor: ui.isDark ? 'rgba(23,26,31,0.88)' : 'rgba(255,255,255,0.94)',
                      ...
                      <Box
                        ...
                        sx={{
                          ...
                          ...((isSelected || isFocused) && {
                            ...
                            '@keyframes pulse': {
                              '0%': { boxShadow: `0 0 0 0 ${alpha(theme.palette.warning.main, 0.52)}` },
