...
function StatCard({ title, value, helper }) {
  ...
  return (
    <Card variant="outlined" sx={{ ...getOfficePanelSx(ui, { borderRadius: 1.5, boxShadow: 'none' }) }}>
              ...
              <AccordionDetails>
                <Stack spacing={1.1}>
                  {sortedLocations.map(([locationName, locationItems]) => {
                    ...
                    return (
                      <Card key={locationKey} variant="outlined" sx={{ ...getOfficePanelSx(ui, { p: 1, borderRadius: 1.5, boxShadow: 'none' }) }}>
                        <Box
                          role="button"
                            ...
                            {locationRows.map((device) => {
                              ...
                              return (
                                <Card
                                  ...
                                  sx={{
                                    ...getOfficePanelSx(ui, { boxShadow: 'none' }),
                                    p: 1,
                                    cursor: 'pointer',
                                    borderRadius: 1.5,
