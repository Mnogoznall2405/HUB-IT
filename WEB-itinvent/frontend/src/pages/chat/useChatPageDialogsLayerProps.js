...
export default function useChatPageDialogsLayerProps(source) {
  ...
  return useMemo(
    () => buildChatPageDialogsLayerProps({
      ...
      selectedFiles,
      imageEdits: selectedImageEdits,
      onApplyImageEdit: applySelectedImageEdit,
      onResetImageEdit: resetSelectedImageEdit,
      fileCaption,
      onFileCaptionChange: setFileCaption,
      sendMediaAsFiles,
      onSendMediaAsFilesChange: changeSendMediaAsFiles,
      preparingFiles,
      sendingFiles,
      fileUploadProgress,
