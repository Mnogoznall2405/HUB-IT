...
export function TasksPageProvider({ controller, children }) {
  const value = useMemo(() => ({
    ...
    filters: pick(controller, [
      ...
      'dateSortDirection', 'setDateSortDirection',
    ...
    detail: pick(controller, [
      'detailsOpen', 'detailsTask', 'detailsLoading', 'selectedMobileTaskView', 'selectedTaskTab', 'selectedTaskView',
      'discussionOpening', 'discussionError', 'discussionConversationId', 'discussionMessageId', 'taskBackLabel',
      'reopeningTaskId', 'detailsComments', 'detailsStatusLog',
      ...
      'canSubmitTask', 'canReviewTask', 'canCloseTask', 'canReopenTask', 'closeTaskDetails', 'closeMobileTaskChecklist',
      'handleCopyTaskLink', 'openEditTask', 'handleDeleteTask', 'handleOpenTaskDiscussion', 'retryTaskDiscussion',
      'handleToggleTaskChecklistItem', 'handleAddTaskChecklistItem', 'handleUploadAttachment',
      'handleDownloadAttachment', 'handleDownloadReport', 'setTaskDetailTab', 'setTaskDetailView', 'setDetailsCommentBody',
      'handleAddTaskComment', 'openMobileTaskChecklist', 'openTransferActReminder', 'handleStartTask',
      'handleOpenReopenTask', 'setSubmitTask', 'setReviewTask', 'setCloseTask', 'renderTaskChecklist', 'openTaskDetails',
      'getTaskActionMenuItems', 'handleTaskMenuAction',
    ]),
    create: pick(controller, [
      ...
      'handleEditDescriptionDraftChange', 'handleEditObserversChange', 'transformTaskMarkdown', 'selectedEditAssignees',
      ...
      'resetProjectDraft', 'resetObjectDraft', 'reviewTask', 'setReviewTask', 'reviewSaving', 'handleReviewTask',
      'reopenTargetTask', 'setReopenTargetTask', 'handleConfirmReopenTask', 'submitTask', 'submitSaving',
      'setSubmitTask', 'handleSubmitTask', 'closeTask', 'setCloseTask', 'closeSaving', 'handleCloseTask',
      'openCreateTaskWithPreset', 'prefetchCreateMeta',
    ]),
