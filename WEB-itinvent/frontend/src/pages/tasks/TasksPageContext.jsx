...
export function TasksPageProvider({ controller, children }) {
  const value = useMemo(() => ({
    ...
    list: pick(controller, [
      ...
      'focusCounts', 'renderTaskCard', 'loadTasks', 'taskUsersLoading', 'taskUsersLoadError',
    ...
    create: pick(controller, [
      ...
      'editOpen', 'setEditOpen', 'editData', 'setEditData', 'editSaving', 'handleSaveEdit',
      'handleEditDescriptionDraftChange', 'transformTaskMarkdown', 'selectedEditAssignee',
