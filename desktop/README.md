...
- закрытие окна скрывает приложение в tray, не останавливая WebView/WebSocket;
...
Дополнительные native-команды управления окном намеренно не входят в этот этап.
