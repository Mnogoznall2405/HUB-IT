...
_Обновлено: 2026-09-16 20:15 UTC_ · инстанс `10.103.0.10:5432/hubit_chat` · скрипт `scripts/pg_schema_docs.py`
...
- **2026-09-16:** авто-синхронизация с `10.103.0.10:5432/hubit_chat` (`app` 154, `chat` 4, `system` 8).
