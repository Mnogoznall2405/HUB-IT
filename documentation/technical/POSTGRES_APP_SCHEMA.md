...
_Обновлено: 2026-06-30 05:52 UTC_ · инстанс `127.0.0.1:5432/hubit_chat` · скрипт `scripts/pg_schema_docs.py`
...
- **2026-06-30:** авто-синхронизация с `127.0.0.1:5432/hubit_chat` (`app` 86, `chat` 1, `system` 8).
