...
_Обновлено: 2026-06-08 09:33 UTC_ · инстанс `127.0.0.1:5432/hubit_chat` · скрипт `scripts/pg_schema_docs.py`
...
- **2026-06-08:** авто-синхронизация с `127.0.0.1:5432/hubit_chat` (`app` 83, `chat` 1, `system` 8).
