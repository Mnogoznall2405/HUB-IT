...
COUNT_QUERIES = [
    ...
    ("Подразделения организаций", "Справочник.ПодразделенияОрганизаций"),
    ("Пользователи", "Справочник.Пользователи"),
    ("Начисления зарплаты", "Документ.НачислениеЗарплаты"),
    ("Ведомости в банк", "Документ.ВедомостьВБанк"),
    ("Приемы на работу", "Документ.ПриемНаРаботу"),
    ("Кадровые переводы", "Документ.КадровыйПеревод"),
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Inspect a 1C infobase through V83.COMConnector."
    )
    parser.add_argument("--server", default=DEFAULT_SERVER)
    parser.add_argument("--ref", default=DEFAULT_REF)
    parser.add_argument("--user", default=DEFAULT_USER)
    parser.add_argument("--password", default=os.environ.get("1C_PASSWORD"))
