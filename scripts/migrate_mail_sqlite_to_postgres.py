...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Migrate mail metadata from SQLite into PostgreSQL app schema.")
...
def main() -> int:
    ...
    MailService(database_url=database_url)
    ...
    print("Mail migration completed:")
    for table_name in TABLES_IN_ORDER:
